...
public class Tree {
    ...
    public Node findNodeByValue(Long value) { // поиск узла по значению
    ...
    public void insertNode(Long value, char letter) { // метод вставки нового элемента
        Node newNode = new Node(); // создание нового узла
        newNode.setValue(value); // вставка данных
        if (rootNode == null) { // если корневой узел не существует
            rootNode = newNode;
            newNode.setLetters(new ArrayList<>(Arrays.asList(letter)));// то новый элемент и есть корневой узел
        }
            ...
            while (true) // мы имеем внутренний выход из цикла
            {
                ...
                if(value.equals(currentNode.getValue())) {// если такой элемент в дереве уже есть, не сохраняем его
                    var array = currentNode.getLetters();
                    array.add(letter);
                    currentNode.setLetters(array);
                    return;    // просто выходим из метода
                }
                else  if (value < currentNode.getValue()) {   // движение влево?
                    currentNode = currentNode.getLeftChild();
                    if (currentNode == null){ // если был достигнут конец цепочки,
                        newNode.setLetters(new ArrayList<>(Arrays.asList(letter)));
    ...
    public boolean deleteNode(Long value) // Удаление узла с заданным ключом
    {
    ...
    public void printTree() { // метод для вывода дерева в консоль
        ...
        while (isRowEmpty == false) {
            ...
            while (globalStack.isEmpty() == false) { // покуда в общем стеке есть элементы
                ...
                if (temp != null) {
                    System.out.print(temp.getValue() + "-" + temp.getLetters()); // выводим его значение в консоли
